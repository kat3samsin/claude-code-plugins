...
Re-run the setup to choose a different terminal.

### Notification Sounds

Available sounds during setup:
- Hero (recommended)
- Glass
- Pop
- Submarine
...
```json
{
  "hooks": {
    "Stop": [{
      ...
      "hooks": [{
        "type": "command",
        "command": "~/.claude/hooks/refocus-handler.sh"
      }]
    }]
  }
}
...
### Wrong terminal activates

Re-run setup and choose the correct terminal.

### No sound plays

Re-run setup and choose a different sound, or check macOS sound settings.
